...
SECRET_KEY = 'django-insecure-etny_#g0i0!f2rd!$&5g@hlk92_n(mgu06(n$cc4yi=e*tal)3'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'gemini',  # Replace with your actual database name
        'USER': 'root',  # Replace with your actual database user
        'PASSWORD': 'Logesh@121!',  # Replace with your actual database password
